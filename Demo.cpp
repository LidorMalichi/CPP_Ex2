...
int main()
{
    ...
    cout<<g4<<endl;           // Should print the multiplication of the matrices of g1 and g2: [0, 0, -4], [-2, 0, -2], [-2, 0, 0]
    ...
    {
        cout << e.what() << endl; // Should print "The graphs aren't the same size."
    }
}